//===- NvfcInstrInfo.h - Nvfc Instruction Information -------*- C++ -*-===//
//
...
/// NvfcII - This namespace holds all of the target specific flags that
...
class NvfcInstrInfo : public TargetInstrInfoImpl {
  const NvfcRegisterInfo RI;
  NvfcTargetMachine &TM;
public:
  explicit NvfcInstrInfo(NvfcTargetMachine &TM);
